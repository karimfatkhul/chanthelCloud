...
<form method="post" name="login">
	...
	<?php if (!empty($_['redirect_url'])) {
		...
		<div class="remember-login-container">
			...
			<input type="checkbox" name="remember_login" value="1" id="remember_login" class="checkbox">
			<?php } else { ?>
			<input type="checkbox" name="remember_login" value="1" id="remember_login" class="checkbox " checked="checked">
			<?php } ?>
